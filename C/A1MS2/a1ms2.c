...
--> check here  <--- missed section********************************** Iforgot check number <= 10 and display form table
Pat.# Name            Phone#
----- --------------- --------------------
--> until here  <--- missed section**********************************
*** No records found ***
...
--> check here  <--- double output********************************** "New patient record added"
<ENTER> to continue...
...
4. TBD
Selection: 2
--> check here  <--- check section**********************************
Contact: HOME
Number : 9994133132
--> until here  <--- check section**********************************
*** New patient record added ***
...
Patient record updated!   <-- my output: "*** New patient record added ***\nPatient record updated!"
...
01032 Puglsey Yanson  (304)800-5191 (CELL)
01040 Beans Maulin    (364)915-5831 (HOME)
01048 Guitar Codi     (___)___-____ (WORK)
01056 Rover Davidov   (793)434-6809 (WORK)
01057 Horse           (___)___-____ (TBD)
01058 Turkey          (___)___-____ (HOME)
****************************************************************
****************************************************************
<ENTER> to continue...
...
Operation aborted.    <-- check here  <--- miss output********************************** 
--> check here  <--- missed space********************************** 
<ENTER> to continue...   <-- my output:  <ENTER> to continue...n
...
Patient record has been removed!    <-- check here  <--- miss output********************************** 
...
Exiting system... Goodbye.   <-- check here  <--- miss output**********************************
